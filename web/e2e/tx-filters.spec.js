...
const row = (page, text) => page.locator(".tx-grid .cat-row", { hasText: text });
const rowCount = (page) => page.locator(".tx-grid .cat-row");

// the toolbar selects are InlineSelect buttons (.gsel) with a shared dropdown
const pickFilter = async (page, current, option) => {
