...
import type { AdminTransaction, Id, User } from "../types.js";
...
export default function AdminTxTab({ user, onClose }: { user: User; onClose: () => void }) {
    ...
    const removeSelected = async () => {
        ...
        try {
            ...
            showToast({ title: "Delete failed", content: String(e), theme: "danger" });
        } finally {
            setBusy(false);
        }
    };
