...
const food = { id: 2, groupId: 2, name: "Food", keywords: "shop|cafe", sort: 1, archived: false };
const rent = { id: 3, groupId: 2, name: "Rent", keywords: "cafe|home", sort: 2, archived: false };
