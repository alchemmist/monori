...
describe("long names never break the layout", () => {
    it("clips a very long transaction description and comment in the ledger", () => {
        ...
        const table = container.querySelector(".tx-grid");
        ...
        const descCell = screen.getByLabelText("Description").closest("td");
        ...
        const commentCell = screen.getByLabelText("Comment").closest("td");
    ...
    it("clips a very long category name on the board and in the budget grid", () => {
        ...
        const cardName = board.querySelector(".kb-card__name");
        ...
        const props = {
            ...
            catsByGroup: new Map([[7, [{ id: 5, name: LONG_CAT }]]]),
            year: 2026,
            currentMonth: 0,
        ...
        const gridLabel = grid.querySelector(".yg-cat-label");
