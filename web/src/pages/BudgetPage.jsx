...
import { MONTHS_SHORT, MONTHS, money } from "../format.js";
                ...
                <>
                    <div className="budget-hero">
                        ...
                        <div className="card hero-card">
                            ...
                            <div className="hero-card__value num">{money(budgetedTotal, base)}</div>
