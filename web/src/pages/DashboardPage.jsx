...
import { money, MONTHS_SHORT } from "../format.js";
        ...
        <div className="fade-in">
            ...
            <div className="kpi-row">
                ...
                <Kpi
                    ...
                    value={money(kpis.exp12avg, base)}
                    sub="last 12 months"
                />
                <Kpi
                    label="Spent this month"
                    value={money(kpis.cur.expense, base)}
                    sub={`vs ${money(kpis.prev.expense, base)} last month`}
                />
                <Kpi
                    label="Daily rate"
                    value={money(kpis.dailyRate, base)}
                    sub="this month, per day"
                />
                <Kpi
                    label="Month forecast"
                    value={money(kpis.forecast, base)}
                    color={kpis.forecast > kpis.exp12avg ? "var(--m-warning)" : "var(--m-income)"}
                    sub="at current pace"
                />
                <Kpi
                    label="Saved"
                    value={money(kpis.saved12, base)}
                    ...
                    <div className="chart-card__body chart-donut">
                        <ChartBoundary>
                            <DonutChart
                                ...
                                valueFormatter={(v) =>
                                    `${v.toLocaleString("ru-RU")} ${currencySymbol(base)}`
                                }
                                cellProps={(cell) => ({
