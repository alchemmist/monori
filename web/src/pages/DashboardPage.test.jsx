...
describe("DashboardPage", () => {
    ...
    it("shows negative net YTD in expense color", () => {
        ...
        const netKpi = screen.getByText("Net year to date").closest(".kpi");
        expect(netKpi).toHaveTextContent("-300 ₽");
        expect(netKpi.querySelector(".kpi__value")).toHaveStyle({ color: "var(--m-expense)" });
    });
    ...
    it("shows positive net YTD in income color", () => {
        ...
        const netKpi = screen.getByText("Net year to date").closest(".kpi");
        expect(netKpi.querySelector(".kpi__value")).toHaveStyle({ color: "var(--m-income)" });
    });
    ...
    it("shows negative savings rate in expense color and zero rate without tint", () => {
        ...
        const savingsKpi = screen.getByText("Savings rate").closest(".kpi");
        expect(savingsKpi).toHaveTextContent("20%");
        expect(savingsKpi.querySelector(".kpi__value")).toHaveStyle({ color: "var(--m-income)" });
    });
    ...
    it("shows negative savings rate in expense color", () => {
        ...
        expect(savingsKpi.querySelector(".kpi__value")).toHaveStyle({ color: "var(--m-expense)" });
    });
    ...
    it("shows forecast in warning color when above average and in income color when below", () => {
        ...
        const forecastKpi = screen.getByText("Month forecast").closest(".kpi");
        expect(forecastKpi.querySelector(".kpi__value")).toHaveStyle({ color: "var(--m-warning)" });
    });
    ...
    it("shows saved in income color for positive and expense for negative", () => {
        ...
        const savedKpi = screen.getByText("Saved").closest(".kpi");
        expect(savedKpi.querySelector(".kpi__value")).toHaveStyle({ color: "var(--m-income)" });
    });
    ...
    it("shows saved in expense color when last 12 months are net negative", () => {
        ...
        const savedKpi = screen.getByText("Saved").closest(".kpi");
        expect(savedKpi.querySelector(".kpi__value")).toHaveStyle({ color: "var(--m-expense)" });
    });
    ...
    it("shows runway warning when under 3 months", () => {
        ...
        const runwayKpi = screen.getByText("Runway").closest(".kpi");
        expect(runwayKpi.querySelector(".kpi__value")).toHaveStyle({ color: "var(--m-warning)" });
    });
    ...
    it("rounds the avg monthly spend to whole roubles", () => {
        ...
        const avgKpi = screen.getByText("Avg monthly spend").closest(".kpi");
