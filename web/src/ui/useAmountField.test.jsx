...
function Field({ initial = "", onValue }) {
...
const edit = (input, value, caret = value.length) => {
...
describe("useAmountField", () => {
    ...
    it("puts the caret back by significant characters, not raw offset", () => {
        ...
        const input = render(<Field />).getByTestId("amt");
