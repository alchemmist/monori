...
const base = () => ({
    ...
    transactions: [
        { id: 2, date: "2026-01-01", amount: 50, accountId: 1, categoryId: 1, transferId: null },
        { id: 7, date: "2026-01-02", amount: -10, accountId: 5, categoryId: 4, transferId: null },
    ],
    connections: [],
});
...
describe("reconcileAccount in the demo", () => {
    ...
    it("counts an absent opening balance as zero", async () => {
        useStore.setState({
            snapshot: { ...base(), accounts: [{ id: 1, name: "Card" }], transactions: [] },
        });
