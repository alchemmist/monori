 ...
 */
export function unionKeywords(a: string | null | undefined, b: string | null | undefined): string {
 ...
 */
export function mergeCategories(snapshot: Snapshot, sourceId: Id, targetId: Id): Snapshot {
...
import type { Id, Snapshot } from "./types.js";
