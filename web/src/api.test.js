...
const ENDPOINTS = [
    ...
    ["deleteTransfer", () => api.deleteTransfer("t"), "/api/transfers/t", "DELETE", undefined],
    [
        "createCategory",
    ...
    [
        "importPreview",
        () => api.importPreview("rows", 1),
        "/api/import/preview",
        "POST",
        { text: "rows", accountId: 1 },
    ],
    [
        "importCommit",
        () => api.importCommit([{ id: 3 }], 1),
        "/api/import/commit",
        "POST",
        { accountId: 1, rows: [{ id: 3 }] },
    ],
    [
